...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='巡检区域表';
...
CREATE TABLE `t_inspection_item` (
  ...
  `deleted` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除：0-未删除，1-已删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=181 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='巡检项表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_inspection_item` VALUES (175,26,'环境温度','environment','normal','温度正常，22°C','2025-06-23 20:40:23','2025-06-23 20:40:23',0),(176,26,'环境湿度','environment','normal','湿度正常，40%RH','2025-06-23 20:40:23','2025-06-23 20:40:23',0),(177,26,'通风状况','environment','normal','通风良好','2025-06-23 20:40:23','2025-06-23 20:40:23',0),(178,26,'设备固定','security','normal','设备固定牢固','2025-06-23 20:40:23','2025-06-23 20:40:23',0),(179,26,'线缆管理','security','normal','线缆整理规范','2025-06-23 20:40:23','2025-06-23 20:40:23',0),(180,26,'配电安全','security','normal','配电正常','2025-06-23 20:40:23','2025-06-23 20:40:23',0);
...
INSERT INTO `t_statistics_cache` VALUES (1,'inspection_count_daily','{\"date\": \"2025-06-10\", \"total\": 6, \"normal\": 5, \"by_area\": [{\"count\": 2, \"area_id\": 13, \"area_name\": \"Server Room A\"}, {\"count\": 2, \"area_id\": 14, \"area_name\": \"Power Room B\"}, {\"count\": 2, \"area_id\": 15, \"area_name\": \"Network Room C\"}], \"abnormal\": 1}','2025-06-11 19:39:33','2025-06-10 19:39:33','2025-06-10 19:39:33'),(2,'inspection_count_weekly','{\"total\": 24, \"by_day\": [{\"date\": \"2025-06-09\", \"count\": 3}, {\"date\": \"2025-06-10\", \"count\": 4}, {\"date\": \"2025-06-11\", \"count\": 3}, {\"date\": \"2025-06-12\", \"count\": 5}, {\"date\": \"2025-06-13\", \"count\": 3}, {\"date\": \"2025-06-14\", \"count\": 3}, {\"date\": \"2025-06-15\", \"count\": 3}], \"normal\": 20, \"abnormal\": 4, \"end_date\": \"2025-06-15\", \"start_date\": \"2025-06-09\"}','2025-06-17 19:39:33','2025-06-10 19:39:33','2025-06-10 19:39:33'),(3,'issue_statistics','{\"total\":7,\"processing\":3,\"closed\":2,\"by_type\":[{\"count\":1,\"type\":\"security\"},{\"count\":4,\"type\":\"environment\"},{\"count\":2,\"type\":\"device\"}],\"open\":2}','2025-06-24 19:20:50','2025-06-10 19:39:33','2025-06-23 19:20:49'),(4,'dashboard_statistics','{\"records\":{\"total\":5,\"lastMonth\":0,\"thisMonth\":5},\"areas\":{\"total\":11,\"inactive\":0,\"active\":11},\"issues\":{\"total\":7,\"processing\":3,\"closed\":2,\"open\":2},\"tasks\":{\"total\":17,\"inProgress\":0,\"pending\":10,\"completed\":0},\"users\":{\"total\":7,\"inactive\":0,\"active\":7}}','2025-06-23 21:33:14','2025-06-10 19:39:33','2025-06-23 20:33:13'),(7,'dashboard_data','{\"tasks\":{\"total\":15,\"active\":8},\"records\":{\"thisMonth\":25,\"thisWeek\":8},\"issues\":{\"total\":12,\"open\":3,\"processing\":2,\"closed\":7},\"users\":{\"total\":5,\"active\":3}}','2025-06-22 17:00:47','2025-06-22 16:00:47','2025-06-22 16:00:47');
...
-- Dump completed on 2025-06-23 20:43:09
