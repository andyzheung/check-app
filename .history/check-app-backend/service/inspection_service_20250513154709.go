...
func (s *InspectionService) GetRecordsByUser(userID uint, page, pageSize int) ([]model.InspectionRecord, int64, error) {
	return s.inspectionRepo.GetByUser(userID, page, pageSize)
}
...
func (s *InspectionService) GetRecordsByArea(areaID uint) ([]model.InspectionRecord, error) {
	return s.inspectionRepo.GetByArea(areaID)
}
