...
func (s *InspectionService) GetRecordsByArea(areaID uint, page, pageSize int) ([]model.InspectionRecord, int64, error) {
	return s.inspectionRepo.GetRecordsByArea(areaID, page, pageSize)
}

// GetRecordsByUserAndTime 获取指定用户在时间范围内的巡检记录
func (s *InspectionService) GetRecordsByUserAndTime(userID uint, startTime, endTime time.Time) ([]model.InspectionRecord, error) {
